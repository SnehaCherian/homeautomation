...
$r1="update devices set start='$a1' where name='device3'";
$s1="update devices set end='$b1' where name='device3'";
$qr1=mysqli_query($x1,$r1);
$qr1=mysqli_query($x1,$s1);
?>
<h1 style="color:white; align="center" font-size:50px >DEVICE3:</h1>
